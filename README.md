...
| Url  | 参数                                          | 实例                                      | 返回结果                     |
| ---- | --------------------------------------------- | ----------------------------------------- | ---------------------------- |
| /k   | ip:需要扫描的IP地址<br />ports:需要扫描的端口 | http://xxxxxx/k?ip127.0.0.1&port=1-65535 | 返回kscan扫描结果            |
| /f   | ip:需要扫描的IP地址<br />ports:需要扫描的端口 | http://xxxxxx/f?ip127.0.0.1&port=1-65535 | 返回fscan扫描结果            |
